...
\usepackage[top=1cm, bottom=0.75in, left=0.8in, right=0.8in]{geometry}
...
\midrule
4$\times$4 & 4 & 9,095 & 96,254 \\
5$\times$5 & 4 & 7,316 & 86,878 \\
6$\times$7 & 4 & 4,365 & 73,422 \\
8$\times$8 & 4 & 3,061 & 56,286 \\
\bottomrule
\end{tabular}
